...
import model.dao.TrenDAO;

/**
 *
 * @author crish
 */
public class TrenControlador extends HttpServlet {

    String findAll="Tren_List.jsp";
    String create="Tren_add.jsp";
    String edit="Tren_edit.jsp";
