...
<%@page import="model.beans.Boleta_Pago"%>
<%@page import="model.dao.Boleta_PagoDAO"%>
    ...
    <body class="blog" >
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Listado Boleta Pago</h1>
            </div>
        ...
        <div class="table table-responsive">
            <table class="table">
                ...
                <%
                    ...
                    List<Boleta_Pago> list = dao.findAll();
                    Iterator<Boleta_Pago> iter = list.iterator();
                    Boleta_Pago asi = null;
                    while (iter.hasNext()) {
                        asi = iter.next();
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= asi.getIdBoletaPago()%></td>
                        <td class="text-center"><%= asi.getId_medio_pago()%></td>
                        <td class="text-center"><%= asi.getIdVenta()%></td>
                          
                        <td>
                                <a class="btn btn-warning" href="Boleta_PagoControlador?accion=edit&id=<%=asi.getIdBoletaPago()%>">Editar</a>    
                                <a class="btn btn-danger" href="Boleta_PagoControlador?accion=delete&id=<%=asi.getIdBoletaPago()%>">Eliminar</a>
                        </td>
                    </tr>
                     <%}%>
                </tbody>
