...
<%@page import="model.beans.Pasaje"%>
<%@page import="model.dao.PasajeDAO"%>
    ...
    <body>
        <section id="container">
            ...
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idPa"));
                Pasaje cli = (Pasaje) dao.findById(id);
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Editar Pasajes</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Cronograma</label>
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cbocrono" class="form-control">
                                                <%                             con = cn.conexion();//(3)

                                                    st = con.createStatement();
                                                    rs = st.executeQuery("select * from cronograma");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="Fecha_pasaje" class="form-control" value="<%= cli.getFecha_pasaje()%>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-md-3 col-xs-11">
                                            <input type="hidden" name="txtCodigo" value="<%= cli.getIdPasaje()%>">
