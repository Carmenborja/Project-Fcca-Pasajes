...
<%@page import="model.beans.Asiento"%>
<%@page import="model.dao.AsientoDAO"%>
    ...
    <body class="blog" >
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Listado Asiento</h1>
            </div>
            ...
            <table class="table">
                <thead>
                    <tr class="table-primary">
                        ...
                        <th class="text-center">N_Asiento</th>
                ...
                <%
                    ...
                    List<Asiento> list = dao.findAll();
                    Iterator<Asiento> iter = list.iterator();
                    Asiento asi = null;
                    while (iter.hasNext()) {
                        asi = iter.next();
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= asi.getIdAsiento()%></td>
                        <td class="text-center"><%= asi.getIdTren()%></td>
                        <td class="text-center"><%= asi.getIdCliente()%></td>
                        <td class="text-center"><%= asi.getN_asiento()%></td>
                        <td class="text-center"><%= asi.getDescripcion_Asiento()%></td>
                          
                        <td>
                                <a class="btn btn-warning" href="AsientoControlador?accion=edit&id=<%=asi.getIdAsiento()%>">Editar</a>    
                                <a class="btn btn-danger" href="AsientoControlador?accion=delete&id=<%=asi.getIdAsiento()%>">Eliminar</a>
                        </td>
                    </tr>
                     <%}%>
                </tbody>
