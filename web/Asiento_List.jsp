        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Listado de Asientos</h3>
                    <a  href="AsientoControlador?accion=add" class="current-item">Agregar Asiento</a>
                    <div class="row mt">
                        <div class="col-lg-12">
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><%= cli.getIdAsiento()%></td>
                                                <td><%= cli.getIdTren()%></td>
                                                <td><%= cli.getNombre()%></td>
                                                <td><%= cli.getN_asiento()%></td>
                                                <td><%= cli.getDescripcion_Asiento()%></td>
                                                <td>
                                                    <a class="btn btn-warning" href="AsientoControlador?accion=edit&id=<%=cli.getIdAsiento()%>">Editar</a>    
                                                    <a class="btn btn-danger" href="AsientoControlador?accion=delete&id=<%=cli.getIdAsiento()%>">Eliminar</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
