            ...
            <div class="form-panel">
              <form class="form-horizontal style-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtNombres" class="form-control" size="16">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtNDocumento" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtTelf" class="form-control">
                  </div>
                </div>
