        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Listado de Paises</h3>
                    <a  href="PaisControlador?accion=add" class="current-item">Agregar Pais</a>
                    <div class="row mt">
                        <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= cli.getNombre()%></td>
                                                <td>
                                                    <a class="btn btn-warning" href="PaisControlador?accion=edit&id=<%=cli.getIdPais()%>">Editar</a>    
                                                    <a class="btn btn-danger" href="PaisControlador?accion=delete&id=<%=cli.getIdPais()%>">Eliminar</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
