    ...
    <body>
        <section id="container">
            ...
            <%
                ...
                Cliente cli = (Cliente) dao.findById(id);
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Editar Cliente</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtNombres" class="form-control" size="16" value="<%= cli.getNombres()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtApellidos" class="form-control" value="<%= cli.getApellidos()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboTipoD" class="form-control" value="<%=cli.getIdTipoD()%>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtNDocumento" class="form-control" value="<%= cli.getnDocumento()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtTelf" class="form-control" value="<%= cli.getTelf()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtDireccion" class="form-control" value="<%= cli.getDireccion()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboG" class="form-control" value="<%=cli.getGenero()%>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="txtFechaN" class="form-control" value="<%= cli.getFechaN()%>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <input type="hidden" name="txtCodigo" value="<%= cli.getIdCliente()%>">
                                        &nbsp
                                        ...
                                        <a href="ClienteControlador?accion=findAll">Regresar</a>
                                    </div>
                            </div>
                            </form>
                        </div>
