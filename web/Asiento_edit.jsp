    ...
    <body>
        <section id="container">
            ...
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idAsi"));
                Asiento cli = (Asiento) dao.findById(id);
                            ...
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-md-3">Tren:</label>
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboTren" class="form-control">
                                                <%                             con = cn.conexion();//(3)

                                                    st = con.createStatement();
                                                    rs = st.executeQuery("select * from tren");
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Nº Asiento:</label>
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtnumero" class="form-control" value="<%= cli.getN_asiento()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtdescripcion" class="form-control" value="<%= cli.getDescripcion_Asiento()%>">
                                        </div>
                                    </div>
