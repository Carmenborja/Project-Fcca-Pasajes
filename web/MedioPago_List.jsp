        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Listado de Medios de Pago</h3>
                    <a  href="MedioPagoControlador?accion=add" class="current-item">Agregar Medio de Pago</a>
                    <div class="row mt">
                        <div class="col-lg-12">
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><%= cli.getIdMedioPago()%></td>
                                                <td><%= cli.getNombre_titular()%></td>
                                                <td><%= cli.getApellidos_titular()%></td>
                                                <td><%= cli.getN_tarjeta()%></td>
                                                <td><%= cli.getCodigo_seguridad()%></td>
                                                <td><%= cli.getFecha_expiracion()%></td>
                                                <td><%= cli.getCorreo()%></td>
                                                <td>
                                                    <a class="btn btn-warning" href="MedioPagoControlador?accion=edit&id=<%=cli.getIdMedioPago()%>">Editar</a>    
                                                    <a class="btn btn-danger" href="MedioPagoControlador?accion=delete&id=<%=cli.getIdMedioPago()%>">Eliminar</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
