  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Editar Trenes</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <form class="form-horizontal style-form">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3">Asientos:</label>
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtAsien" class="form-control" size="16" value="<%= cli.getAsientos()%>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtDescr" class="form-control" value="<%= cli.getDescripcion_tren()%>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtRuta" class="form-control" value="<%= cli.getRuta()%>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtCantCo" class="form-control" value="<%= cli.getCantidadCoche()%>">
                  </div>
                </div>
