...
<%@page import="model.beans.Reserva"%>
    ...
    <body>
        <section id="container">
            ...
            <%
                ...
                Reserva cli = (Reserva) dao.findById(id);
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Editar Reserva</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="txtfecha" class="form-control" value="<%= cli.getFecha()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtDesc" class="form-control" value="<%= cli.getDescripcion()%>">
                                        </div>
                                    </div>
