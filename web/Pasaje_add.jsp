        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Registro de Pasajes</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cbocrono" class="form-control">
                                                ...
                                                <%
                                                    for (int i = 0; i < id_cronograma.size(); i++) {
                                                        String nom = id_cronograma.get(i).toString();
                                                %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="Fecha_pasaje" class="form-control">
                                        </div>
                                    </div>
