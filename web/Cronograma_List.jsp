    ...
    <body class="blog" >
                    ...
                    <div class="header">
                        ...
                        <nav class="header__navigation collapse navbar-toggleable-md" id="bolts-main-navigation">
                            <ul id="menu-main-menu" class="main-navigation  js-main-nav" role="menubar">
                                <li class="menu-item"><a href="Principal_Empleado.html">Menu</a></li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item "><a href="Pais_List.jsp">Pais</a></li>
                                    <li class="menu-item current-menu-item" ><a href="Cronograma_List.jsp">Cronograma</a></li>
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Listado Cronograma</h1>
            </div>
            ...
            <table class="table">
                <thead>
                    <tr class="table-primary">
                        ...
                        <th class="text-center">Hora Partida</th>
                        <th class="text-center">Hora Llegada</th>                           
                        <th class="text-center">Fecha Salida</th>
                        <th class="text-center">Fecha Retorno</th> 
                        <th class="text-center">Estacion Inicio</th> 
                        <th class="text-center">Estacion Final</th>
                ...
                <%
                    ...
                    List<Cronograma> list = dao.findAll();
                    Iterator<Cronograma> iter = list.iterator();
                    Cronograma asi = null;
                    while (iter.hasNext()) {
                        asi = iter.next();
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= asi.getIdCronograma()%></td>
                        <td class="text-center"><%= asi.getIdTerminal()%></td>
                        <td class="text-center"><%= asi.getIdTarifa()%></td>
                        <td class="text-center"><%= asi.getHora_partida()%></td>
                        <td class="text-center"><%= asi.getHora_llegada()%></td>
                        <td class="text-center"><%= asi.getFecha_salida()%></td>
                        <td class="text-center"><%= asi.getFecha_retorno()%></td>
                        <td class="text-center"><%= asi.getEstacion_inicio()%></td>
                        <td class="text-center"><%= asi.getEstacion_fin()%></td>
                          
                        <td>
                                <a class="btn btn-warning" href="CronogramaControlador?accion=edit&id=<%=asi.getIdCronograma()%>">Editar</a>    
                                <a class="btn btn-danger" href="CronogramaControlador?accion=delete&id=<%=asi.getIdCronograma()%>">Eliminar</a>
                        </td>
                    </tr>
                     <%}%>
                </tbody>
