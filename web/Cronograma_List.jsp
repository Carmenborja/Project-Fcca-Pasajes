        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Listado de Cronogramas</h3>
                    <a  href="CronogramaControlador?accion=add" class="current-item">Agregar Cronograma</a>
                    <div class="row mt">
                        <div class="col-lg-12">
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><%= cli.getIdCronograma()%></td>
                                                <td><%= cli.getIdTerminal()%></td>
                                                <td><%= cli.getIdTarifa()%></td>
                                                <td><%= cli.getHora_partida()%></td>
                                                <td><%= cli.getHora_llegada()%></td>
                                                <td><%= cli.getFecha_salida()%></td>
                                                <td><%= cli.getFecha_retorno()%></td>
                                                <td><%= cli.getEstacion_inicio()%></td>
                                                <td><%= cli.getEstacion_fin()%></td>
                                                <td>
                                                    <a class="btn btn-warning" href="CronogramaControlador?accion=edit&id=<%=cli.getIdCronograma()%>">Editar</a>    
                                                    <a class="btn btn-danger" href="CronogramaControlador?accion=delete&id=<%=cli.getIdCronograma()%>">Eliminar</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
