<%-- 
    Document   : Tarifa_add
    Created on : 01-dic-2019, 16:30:34
    Author     : crish
--%>
    ...
    <body class="blog" >
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Mantenimiento Tarifa</h1>
            </div>
        ...
        <div class="container">
            <div class="col-lg-6"  >
                <form class="form-group">                   
                    Tipo de Viaje:
                    <input type="text" name="txtidTviaje" class="form-control"><br> 
                    Categoria:
                    <input type="text" name="txtidCat" class="form-control"><br>                   
                    Costo:
