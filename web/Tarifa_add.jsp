  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Registro de Tarifas</h3>
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <form class="form-horizontal style-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtidTviaje" class="form-control" size="16">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtidCat" class="form-control" size="16">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtCosto" class="form-control" size="16">
                  </div>
                </div>
