    ...
    <body>
        <section id="container">
            ...
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idTer"));
                Terminal cli = (Terminal) dao.findById(id);
                            ...
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtNom_Ter" class="form-control" value="<%= cli.getNombre_Terminal()%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtdir_Ter" class="form-control" value="<%= cli.getDireccion_Terminal()%>">
                                        </div>
                                    </div>
                                            <div class="form-group">
                                        <label class="control-label col-md-3">Telefono:</label>
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txttelf_Ter" class="form-control" value="<%= cli.getTelefono_Terminal()%>">
                                        </div>
                                    </div>
