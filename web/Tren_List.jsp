        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Listado de Trenes</h3>
                    <a  href="TrenControlador?accion=add" class="current-item">Agregar Tren</a>
                    <div class="row mt">
                        <div class="col-lg-12">
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%= cli.getIdTren()%></td>
                                                <td><%= cli.getAsientos()%></td>
                                                <td><%= cli.getDescripcion_tren()%></td>
                                                <td><%= cli.getRuta()%></td>
                                                <td><%= cli.getCantidadCoche()%></td>
                                                <td>
                                                    <a class="btn btn-warning" href="TrenControlador?accion=edit&id=<%=cli.getIdTren()%>">Editar</a>    
                                                    <a class="btn btn-danger" href="TrenControlador?accion=delete&id=<%=cli.getIdTren()%>">Eliminar</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
