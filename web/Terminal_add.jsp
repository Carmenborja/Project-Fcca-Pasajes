                            ...
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboTren" class="form-control">
                                                ...
                                                <%
                                                    for (int i = 0; i < id_tren.size(); i++) {
                                                        String nom = id_tren.get(i).toString();
                                                %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtNom_Ter" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtdir_Ter" class="form-control">
                                        </div>
                                    </div>
                                            <div class="form-group">
                                        <label class="control-label col-md-3">Telefono:</label>
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txttelf_Ter" class="form-control">
                                        </div>
                                    </div>
