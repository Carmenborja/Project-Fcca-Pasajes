  ...
  <section id="container">
    <header class="header black-bg">
      ...
      <%
                ...
                Empleado cli = (Empleado) dao.findById(id);
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Editar Empleados</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <form class="form-horizontal style-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtTelefono" class="form-control" value="<%= cli.getTelefono()%>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="control-label col-md-3">Ususario:</label>
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtuser" class="form-control" value="<%= cli.getUsuario()%>">
                  </div>
                </div>
        ...
        <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="password" name="txtpass" class="form-control" value="<%= cli.getContraseña()%>">
                  </div>
                </div>
