        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i>Registro de Cronogramas</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboTerminal" class="form-control">
                                                ...
                                                <%
                                                    for (int i = 0; i < nombre_terminal.size(); i++) {
                                                        String nom = nombre_terminal.get(i).toString();
                                                %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <select name="cboTarifa" class="form-control">
                                                <option value="0" selected>Seleccionar...</option>
                                                <%
                                                    for (int i = 0; i < costo_tarifa.size(); i++) {
                                                        String nom = costo_tarifa.get(i).toString();
                                                %>
                                                <option value="<%=i + 1%>"><%=nom%></option>
                                                <%  }%>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="time" name="txthor_partida" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="time" name="txthor_llegada" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="txtfech_sal" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="date" name="txtfech_ret" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtest_inicio" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input type="text" name="txtest_fin" class="form-control">
                                        </div>
                                    </div>
