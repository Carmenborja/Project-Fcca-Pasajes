...
<html lang="en-GB">
    ...
    <body class="blog" >
            ...
            <header class="site-header site-header--werk">
                        ...
                        <div class="header">
                            ...
                            <nav class="header__navigation collapse navbar-toggleable-md" id="bolts-main-navigation">
                                <ul id="menu-main-menu" class="main-navigation  js-main-nav" role="menubar">
                                    ...
                                    <li class="menu-item menu-item-has-children current-menu-item"><a href="Empleado_add.jsp">Empleado</a></li>
                ...
                <div class="container">
                    <div class="page-header__text">
                        <h1 class="page-header__title"> Mantenimiento Empleado</h1>
            ...
            <div class="container">
        <div class="form-control" style="width:700px;height:980px" >
                ...
                <div class="form-group col-5">
                    ...
                    <select name="cboTipo">
                        ...
                        <option value="2">Promotora de Ventas</option>
                    </select>
                </div>
                <div class="form-group col-5">
                    Estado<br>
                ...
                <div class="form-group right">
                    <input class="btn btn-success" class="form-control" type="submit" name="accion" value="Registrar" >
                    <input type="reset" name="Limpiar" class="btn btn-primary" class="form-control">
                    <a href="EmpleadoControlador?accion=findAll">Regresar</a>
                </div><br>
