...
<%@page import="model.beans.Detalle_Reserva"%>
<%@page import="model.dao.Detalle_ReservaDAO"%>
    ...
    <body class="blog" >
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Listado Detalle de Reserva</h1>
            </div>
        ...
        <div class="table table-responsive">
            <table class="table">
                ...
                <%
                    ...
                    List<Detalle_Reserva> list = dao.findAll();
                    Iterator<Detalle_Reserva> iter = list.iterator();
                    Detalle_Reserva asi = null;
                    while (iter.hasNext()) {
                        asi = iter.next();
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= asi.getIdDetalleReserva()%></td>
                        <td class="text-center"><%= asi.getIdPasaje()%></td>
                        <td class="text-center"><%= asi.getIdReserva()%></td>
                        <td class="text-center"><%= asi.getDuracion()%></td>
                          
                        <td>
                                <a class="btn btn-warning" href="Detalle_ReservaControlador?accion=edit&id=<%=asi.getIdDetalleReserva()%>">Editar</a>    
                                <a class="btn btn-danger" href="Detalle_ReservaControlador?accion=delete&id=<%=asi.getIdDetalleReserva()%>">Eliminar</a>
                        </td>
                    </tr>
                     <%}%>
                </tbody>
