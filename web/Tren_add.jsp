<%-- 
    Document   : Tren_add
    Created on : 01-dic-2019, 16:31:03
    Author     : crish
--%>
    ...
    <body class="blog" >
        ...
        <div class="container">
            <div class="page-header__text">
                <h1 class="page-header__title">Mantenimiento Tren</h1>
                <a class="btn btn-warning" href="TrenControlador?accion=add">Agregar</a>
            </div>
        ...
        <div class="container">
            <div class="col-lg-6"  >
                <form class="form-group">                   
                    Asientos:
                    <input type="text" name="txtAsien" class="form-control"><br> 
                    Descripcion:
                    <input type="text" name="txtDescr" class="form-control"><br>                   
                    Ruta:
                    <input type="text" name="txtRuta" class="form-control"><br> 
                    Cantidad de Coches:
                    <input type="text" name="txtCantCo" class="form-control"><br> 
