  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Registro de Trenes</h3>
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <form class="form-horizontal style-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtAsien" class="form-control" size="16">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtDescr" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtRuta" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input type="text" name="txtCantCo" class="form-control">
                  </div>
                </div>
